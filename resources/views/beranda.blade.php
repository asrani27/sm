...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/me-master/fonts/icomoon/style.css">

    <link rel="stylesheet" href="/me-master/css/bootstrap.min.css">
    <link rel="stylesheet" href="/me-master/css/jquery-ui.css">
    <link rel="stylesheet" href="/me-master/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/me-master/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="/me-master/css/owl.theme.default.min.css">

    <link rel="stylesheet" href="/me-master/css/jquery.fancybox.min.css">

    <link rel="stylesheet" href="/me-master/css/bootstrap-datepicker.css">

    <link rel="stylesheet" href="/me-master/fonts/flaticon/font/flaticon.css">
  ...
  <div class="site-wrap">
      ...
      <div class="container-fluid">
        <div class="row align-items-center justify-content-center">
          ...
          <div class=" text-center mx-5">
            <h1 class="m-0 site-logo"><a href="/gabung">H. MUKHYAR</a></h1>
          </div>
    ...
    <div class="site-blocks-cover overlay bg-light" id="home-section">
      ...
      <img src="/me-master/images/face3.png" alt="Image" class="img-face" >
    ...
    <div class="site-section" id="visi-misi">
      <div class="container">
        <div class="row ">
      ...
      <div class="container">
        <div class="row ">
          ...
          <div class="col-lg-4 order-1 order-lg-2 mb-4 mb-lg-0">
            ...
            <img src="/me-master/images/face2.png" alt="Image" class="img-fluid">
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div id="posts" class="row no-gutter">
          <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
            <a href="/me-master/images/post_2.jpg" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="/me-master/images/post_2.jpg">
            </a>
          </div>
          <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
            <a href="/me-master/images/post_3.jpg" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="/me-master/images/post_3.jpg">
            </a>
          </div>

          <div class="item brand col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
            <a href="/me-master/images/post_4.jpg" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="/me-master/images/post_4.jpg">
            </a>
          </div>

          <div class="item design col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">

            <a href="/me-master/images/post_5.jpg" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="/me-master/images/post_5.jpg">
            </a>

          </div>

          <div class="item web col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
            <a href="/me-master/images/post_6.jpg" class="item-wrap fancybox">
              <span class="icon-search2"></span>
              <img class="img-fluid" src="/me-master/images/post_6.jpg">
            </a>
          </div>
        ...
        <div class="owl-carousel slide-one-item">
          <div class="slide">
            <blockquote>
              ...
              <p><cite>&mdash; Fakhruddin</cite></p>
            </blockquote>
          </div>
          <div class="slide">
            <blockquote>
              <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              <p><cite>&mdash; Ari Sukandar</cite></p>
            </blockquote>
          </div>
          <div class="slide">
            <blockquote>
              <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
              <p><cite>&mdash; Jaya Budiantoro</cite></p>
            </blockquote>
          </div>
        </div>
      </div>
  ...
  <script src="/me-master/js/jquery-3.3.1.min.js"></script>
  <script src="/me-master/js/jquery-ui.js"></script>
  <script src="/me-master/js/popper.min.js"></script>
  <script src="/me-master/js/bootstrap.min.js"></script>
  <script src="/me-master/js/owl.carousel.min.js"></script>
  <script src="/me-master/js/jquery.easing.1.3.js"></script>
  <script src="/me-master/js/aos.js"></script>
  <script src="/me-master/js/jquery.fancybox.min.js"></script>
  <script src="/me-master/js/jquery.sticky.js"></script>
  <script src="/me-master/js/isotope.pkgd.min.js"></script>

  
  <script src="/me-master/js/main.js"></script>
